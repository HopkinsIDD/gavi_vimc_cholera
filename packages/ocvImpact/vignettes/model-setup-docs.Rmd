...
1. First we unzip a file needed for the model using `unzip input_data/incidence/afro_2010-2016_lambda_5k.zip`. The reason why we need to do it is that GitHub has a limit for the file size, we had to zip it before uploading it. 
