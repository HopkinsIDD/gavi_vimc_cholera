...
params: 
  ...
  country: ["GHA"] #country code specified or all the countries will be used for the diagnostic report
...
if(1/1000 %in% params$vac_incid_thresholds){
  plt <- plot_cases(cache = cache, case_type = "clinical_case", threshold = 1/1000, cumulative_type = "non_cumulative")
}else{
  plt <- ggplot() +
    theme_void() +
    geom_text(aes(0,0,label='N/A')) +
...
if(1/5000 %in% params$vac_incid_thresholds){
  plt <- plot_cases(cache = cache, case_type = "clinical_case", threshold = 1/5000, cumulative_type = "non_cumulative")
}else{
  plt <- ggplot() +
    theme_void() +
    geom_text(aes(0,0,label='N/A')) +
...
if(1/10000 %in% params$vac_incid_thresholds){
  plt <- plot_cases(cache = cache, case_type = "clinical_case", threshold = 1/10000, cumulative_type = "non_cumulative")
}else{
  plt <- ggplot() +
    theme_void() +
    geom_text(aes(0,0,label='N/A')) +
...
if(1/1000 %in% params$vac_incid_thresholds){
  plt <- plot_cases(cache = cache, case_type = "clinical_case", threshold = 1/1000, cumulative_type = "district_level")
}else{
  plt <- ggplot() +
    theme_void() +
    geom_text(aes(0,0,label='N/A')) +
...
if(1/5000 %in% params$vac_incid_thresholds){
  plt <- plot_cases(cache = cache, case_type = "clinical_case", threshold = 1/5000, cumulative_type = "district_level")
}else{
  plt <- ggplot() +
    theme_void() +
    geom_text(aes(0,0,label='N/A')) +
...
if(1/10000 %in% params$vac_incid_thresholds){
  plt <- plot_cases(cache = cache, case_type = "clinical_case", threshold = 1/10000, cumulative_type = "district_level")
}else{
  plt <- ggplot() +
    theme_void() +
    geom_text(aes(0,0,label='N/A')) +
...
if(1/1000 %in% params$vac_incid_thresholds){
  plt <- plot_cases(cache = cache, case_type = "clinical_case", threshold = 1/1000, cumulative_type = "country_level")
}else{
  plt <- ggplot() +
    theme_void() +
    geom_text(aes(0,0,label='N/A')) +
...
if(1/5000 %in% params$vac_incid_thresholds){
  plt <- plot_cases(cache = cache, case_type = "clinical_case", threshold = 1/5000, cumulative_type = "country_level")
}else{
  plt <- ggplot() +
    theme_void() +
    geom_text(aes(0,0,label='N/A')) +
...
if(1/10000 %in% params$vac_incid_thresholds){
  plt <- plot_cases(cache = cache, case_type = "clinical_case", threshold = 1/10000, cumulative_type = "country_level")
}else{
  plt <- ggplot() +
    theme_void() +
    geom_text(aes(0,0,label='N/A')) +
...
#Back-ups
# # Function that returns cases plots (case type: true_case, clinical_case, averted_tr_case, averted_ob_case) (cumulative_type: non_cumulative, district_level, country_level)
