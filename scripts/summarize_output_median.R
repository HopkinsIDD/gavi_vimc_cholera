...
df_prob <- read.csv("df_small_targets.csv")
pop <- raster("ppp_2020_5km_Aggregated.tif")
inc <- raster("afro_2010-2016_lambda_5k_mean.tif")
case <- pop * inc
...
write.csv(df_small_targets_summary, "eff_table/df_small_targets_summary.csv", row.names = FALSE)
