...
setwd('C:/Users/ZOU/Desktop/Diagnostics Report')
cen_camp  <- read_csv('central-burden-template.201910gavi-5.Cholera_campaign-default.csv')
cen_novax <- read_csv('central-burden-template.201910gavi-5.Cholera_no-vaccination.csv')
```
...
int_pop <- read_csv('C:/Users/ZOU/Desktop/Diagnostics Report/montagu_interpolated_pop.csv')
int_pop <- int_pop %>% 
...
all_countries <- pop_plot_all_countries %>% 
  ...
  summarise(freq = n()) %>% 
  mutate(Countries = country, PopulationDifference = population_value, Frequency = freq, Proportion = freq/(nrow(pop_plot_all_countries)/15)) %>% 
