...
params: 
  ...
  country: ["BEN"] #country code specified or all the countries will be used for the diagnostic report
  admin_level: ["both"] #either "both", "admin1", or "admin2"
  vac_incid_thresholds: ["0.001"] #["0.001", "2e-04", "1e-04"] if to plot all thresholds 
...
# params$country <- c("AGO") #country code specified or all the countries will be used for the diagnostic report
# params$admin_level <- c("both")
# params$vac_incid_thresholds <- c("0.001")
