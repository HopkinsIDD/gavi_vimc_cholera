...
params: 
  ...
  country: ["SOM"] #country code specified or all the countries will be used for the diagnostic report
  admin_level: ["admin2"] #either "both", "admin1", or "admin2"
...
#### Threshold 1/1000
```{r echo=FALSE}
if((1/1000) %in% vac_incid_thresholds & params$admin_level %in% c("both", "admin1")){
...
#### Threshold 1/5000
```{r echo=FALSE}
if((1/5000) %in% vac_incid_thresholds & params$admin_level %in% c("both", "admin1")){
...
#### Threshold 1/10000
```{r echo=FALSE}
if((1/10000) %in% vac_incid_thresholds & params$admin_level %in% c("both", "admin1")){
