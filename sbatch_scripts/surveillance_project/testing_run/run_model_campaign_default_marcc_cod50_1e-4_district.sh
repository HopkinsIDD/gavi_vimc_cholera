...
Rscript -e "Sys.setenv(R_LIBRARY_DIRECTORY='$R_LIBRARY_DIRECTORY'); 
            ...
            Sys.setenv(CHOLERA_CONFIG='configs/202110gavi-3/campaign-default/district-estimate/1e-04/COD_campaign-default_district-estimate_50.yml'); 
