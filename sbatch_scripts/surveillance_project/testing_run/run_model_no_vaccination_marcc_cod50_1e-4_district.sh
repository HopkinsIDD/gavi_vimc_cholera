...
export CHOLERA_CONFIG_DIRECTORY=/data/aazman1/$USER/gavi-modeling/gavi_vimc_cholera/configs/202110gavi-3/no-vaccination/district-estimate/0.001
...
Rscript -e "Sys.setenv(R_LIBRARY_DIRECTORY='$R_LIBRARY_DIRECTORY'); 
            ...
            Sys.setenv(CHOLERA_CONFIG='configs/202110gavi-3/no-vaccination/district-estimate/1e-04/COD_no-vaccination_district-estimate_50.yml'); 
