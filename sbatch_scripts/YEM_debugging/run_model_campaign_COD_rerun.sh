#!/bin/bash
#SBATCH --job-name=rerun_cod
#SBATCH --time=10000:00:00
#SBATCH --ntasks=1
#SBATCH --mem=10G
#SBATCH --output=YEM_debugging_log/cod_rerun.txt
...
cd $TAXDIR
$RSCRIPT $TAXDIR/scripts/run_model.R -c $TAXDIR/configs/202110gavi-3/campaign-default/COD_campaign-default_30.yml
